                    ...
                    <Fragment>
                        {!hotel ? <NotFound /> : (
                            <div className="w-[80%] sm:w-[60%] md:w-[70%] mx-auto mt-3">
                                <div className="flex flex-col md:flex-row gap-6 md:gap-4 items-center md:justify-between ">
                                    ...
                                    <div>
                                        <div className="flex gap-4">
                                            <h4 className="font-medium">Tên khách sạn:</h4><p className="font-normal text-blue-400"><Link to={`/hotel/${id}`} >{hotel?.name}</Link></p>
                                        </div>
                                        <div className="flex gap-4">
                                ...
                                <h2 className="text-2xl font-medium text-center my-8">Tạo phòng mới</h2>
                                <form className="flex flex-col gap-4 px-2 max-w-fit mx-auto mb-8" onSubmit={(e) => handleSubmit(e)}>
                                    ...
                                    <div className="border border-solid border-gray-400 py-3 px-5 rounded">
                                        ...
                                        <input type="number" required={true} value={number} onChange={(e) => setNumber(e.target.value)} placeholder="Số phòng" className="w-40 sm:w-60 md:w-80 ml-3 outline-none bg-transparent" />
                                    </div>
                                    <div className="border border-solid border-gray-400 py-3 px-5 rounded">
