                        ...
                        <div className="flex flex-col md:min-h-60 gap-8 bg-gray-200  pt-4 md:items-center">
                            ...
                            <div className="md:w-7/12 mx-4 md:my-6 mb-6">
                                <div className="flex justify-between">
                                    ...
                                    <a href="#rooms" className="bg-red-400 text-gray-50 p-3 rounded hover:bg-red-500">Đặt phòng</a>
                                </div>
                                <span className="font-medium text-gray-700">
                             <  MapIcon className="mb-1" /> 
                                <span className="font-normal">{hotel?.address}</span> 
                                </span>
                                <p className="my-3">{hotel?.description}</p>
                                <span className="font-medium text-gray-700"><LocationOnIcon className="mb-1" /><span className=" font-normal">{hotel?.distance}km từ trung tâm thành phố</span></span>
                            ...
                            <div id="rooms" className="mx-4 md:mx-0 -mt-4 mb-8 md:w-9/12">
                                <span className="text-2xl mx-auto w-52 pb-2 block font-medium text-center border-b-2 border-solid border-gray-400">Chọn phòng</span>
