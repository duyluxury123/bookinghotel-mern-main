            ...
            <div className="mx-auto px-4 md:px-10 lg:px-20 xl:px-48 mt-4 flex flex-col md:flex-row justify-between pb-6 h-[calc(100vh-115px)]">
                <div className="w-full h-full mb-6 bg-slate-100 border border-solid border-gray-300 rounded flex flex-col">
                    ...
                    <div className="h-12 flex items-center justify-between px-6 border-b border-solid border-gray-400">
                        <Link to="/me/update" className=" text-blue-600" >Thiết lập tài khoản</Link>
                    ...
                    <div className="h-12 flex items-center justify-between px-6 border-b border-solid border-gray-400 mb-2">
                        <Link to="/me/bookings" className=" text-blue-600" >Đặt phòng của bạn</Link>
                        <ArrowForwardIosIcon fontSize="small" className="text-blue-600" />
                    </div>
                    {user?.role === "admin" && (
                    <div className="h-10 flex items-center justify-between px-6 border-b border-solid border-gray-400 mb-2">
                        <button onClick={() => navigate("/admin/dashboard")} className=" text-blue-600 disabled:text-blue-400" disabled={user?.role !== "admin" ? true : false}>Quản lý khách sạn</button>
                    ...
                    <div className="mt-auto self-center mb-2 sm:mb-2 md:mb-6">
                        <button onClick={logoutHandler} className="bg-red-400 hover:bg-red-500 py-2 rounded-lg w-48 text-center text-neutral-50 font-thin transition duration-200 ">Đăng xuất</button>
                    </div>
                </div>
