                                ...
                                <div className="w-[80%] sm:w-[60%] md:w-[70%] mx-auto mt-3">
                                    <div className="flex flex-col md:flex-row gap-6 md:gap-4 justify-between">
                                        <div className="flex gap-4">
                                            ...
                                            <Button onClick={() => navigate(`/admin/hotel/${id}/room/new`)} variant="outlined" className="!border-red-400 !text-red-400"><WeekendIcon fontSize="small" className="mr-2" />THÊM PHÒNG</Button>
                                        </div>
                                        <div>
                                            <div className="flex gap-4">
                                    ...
                                    <h2 className="text-2xl font-medium text-center my-8">Tất cả phòng</h2>
                                        ...
                                        <Table className="min-w-[700px]">
                                            <TableHead >
                                                <TableRow className="bg-red-300">
                                                    ...
                                                    <TableCell align="center">Thêm hình ảnh phòng</TableCell>
                                    ...
                                    <Dialog open={open} scroll="body" className="!w-screen" fullWidth={true}>
                                        <div className="p-4" >
                                            <DialogTitle className="text-center">Tải hình ảnh phòng</DialogTitle>
                                    ...
                                    <Dialog open={isDeleteOpen}>
                                        <div className="p-4" >
                                            <DialogTitle className="text-center">Xóa phòng?</DialogTitle>
                                            <DialogContent className="m-8">
                                                <DialogContentText className="text-gray-900">Thao tác này sẽ xóa phòng khỏi khách sạn.</DialogContentText>
                                            </DialogContent>
