            ...
            <div className="mx-auto px-4 md:px-10 lg:px-20 xl:px-48 mt-4">
                ...
                <div className="px-1 sm:px-3 flex justify-center">
                    <div className="flex flex-col gap-4">
                        ...
                        <button onClick={() => submitHandler()} type="submit" ref={payBtn} className="py-4 w-56 block text-center rounded bg-red-400 hover:bg-red-500 transition duration-200 text-zinc-50 disabled:cursor-not-allowed">{`Thanh toán - ${bookingDetails?.totalPrice.toLocaleString("vi-VN", {
                            style: "currency",
                            currency: "VND",
                        }) + ""}`}</button>
                    </div>
