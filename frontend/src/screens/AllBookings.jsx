...
const AllBookings = () => {
  ...
  const rowsPerPage = 5;
  const emptyRows = Math.max(0, (1 + page) * rowsPerPage - sortedBookings?.length);
  ...
  useEffect(() => {
    if (allBookings) {
      const sorted = [...allBookings].sort((a, b) => {
        ...
        return dateB - dateA; // Sắp xếp giảm dần, từ mới nhất đến cũ nhất
      });
  ...
  const editHandler = () => {
    ...
    // Cập nhật danh sách đã sắp xếp và danh sách gốc
    setSortedBookings([...allBookings].sort((a, b) => {
      const dateA = new Date(a.createdAt);
      const dateB = new Date(b.createdAt);
      return dateB - dateA;
    }));
                ...
                <Table className="min-w-[700px]">
                  <TableHead>
                    <TableRow className="bg-red-300">
                      ...
                      <TableCell align="center">Trạng thái đặt phòng</TableCell>
                      <TableCell align="center">Ngày đặt phòng</TableCell>
                    ...
                    {(rowsPerPage > 2
                      ...
                      <TableRow key={booking._id} style={{ height: 72.8 }}>
                        ...
                        <TableCell align="center">
                          ...
                          <Tooltip
                            title={
                              booking.status === "Đã hoàn thành" ? "" : "Edit"
                            }
                            placement="right"
                            className="!ml-2"
                          >
                  ...
                  <DialogContent className="m-4 !overflow-visible">
                    <FormControl fullWidth>
                      ...
                      >
                        ...
                        <MenuItem value="Đã hủy">Huỷ bỏ</MenuItem>
                      </Select>
                    </FormControl>
                  </DialogContent>
