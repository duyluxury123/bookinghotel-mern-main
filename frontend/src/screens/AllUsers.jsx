                ...
                <Fragment>
                    {isUsersLoading ? <Loader /> : (
                        <div className="w-[80%] sm:w-[60%] md:w-[70%] mx-auto mt-3">
                            <h2 className="text-2xl font-medium text-center my-8">Tất cả người dùng</h2>
                            ...
                            <Dialog open={open}>
                                <div className="p-5">
                                    <DialogTitle className="text-center">Thay đổi vai trò người dùng</DialogTitle>
                                    ...
                                    <DialogActions className="mt-4">
                                        <button onClick={() => setOpen(!open)} className="bg-red-400 hover:bg-red-500 py-2 rounded-lg w-24 text-center text-neutral-50  transition duration-200 font-semibold">Hủy </button>
                                        <button disabled={role === userRef?.role ? true : false} onClick={editHandler} className=" border-red-400 text-red-400 hover:text-red-500 hover:border-red-500 hover:bg-red-200 border-solid border py-2 rounded-lg w-24 text-center transition duration-200 box-border">Cập nhật</button>
                                    </DialogActions>
                                </div>
                            </Dialog>
                        </div>
